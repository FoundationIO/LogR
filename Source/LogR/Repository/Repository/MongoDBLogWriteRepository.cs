...
{
    public class MongoDBLogWriteRepository : BaseLogRepository, ILogWriteRepository
    {
        private ISqlIndexStoreDBManager dbManager;

        public MongoDBLogWriteRepository(ILog log, IAppConfiguration config, ISqlIndexStoreDBManager dbManager)
            : base(log, config)
        {
