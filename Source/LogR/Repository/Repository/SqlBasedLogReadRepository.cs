...
{
    public class SqlBasedLogReadRepository : BaseLogRepository, ILogReadRepository
    {
        private ISqlIndexStoreDBManager dbManager;

        public SqlBasedLogReadRepository(ILog log, IAppConfiguration config, ISqlIndexStoreDBManager dbManager)
            : base(log, config)
        {
