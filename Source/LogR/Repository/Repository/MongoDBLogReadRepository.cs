...
{
    public class MongoDBLogReadRepository : BaseLogRepository, ILogReadRepository
    {
        private ISqlIndexStoreDBManager dbManager;

        public MongoDBLogReadRepository(ILog log, IAppConfiguration config, ISqlIndexStoreDBManager dbManager)
            : base(log, config)
        {
