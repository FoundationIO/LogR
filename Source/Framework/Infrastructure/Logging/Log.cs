...
namespace Framework.Infrastructure.Logging
{
    public class Log : ILog
    {
        ...
        private NLog.Logger perfLogger = null;
        ...
        public void Trace(string str, [CallerLineNumber] int sourceLineNumber = 0, [CallerMemberName] string memberName = "", [CallerFilePath] string sourceFilePath = "")
        {
            if (logConfig.LogTrace)
                this.LogEvent("TRACE", LogLevel.Trace, str, string.Empty, string.Empty, sourceLineNumber, memberName, sourceFilePath);
        }
        ...
        {
            if (logConfig.LogTrace)
                this.LogEvent("TRACE", LogLevel.Trace, $"{str} " + (ex != null ? $"Exception - {ex.RecursivelyGetExceptionMessage()}" : string.Empty), string.Empty, string.Empty, sourceLineNumber, memberName, sourceFilePath);
        }
        ...
        public void Debug(string str, [CallerLineNumber] int sourceLineNumber = 0, [CallerMemberName] string memberName = "", [CallerFilePath] string sourceFilePath = "")
        {
            if (logConfig.LogDebug)
                this.LogEvent("DEBUG", LogLevel.Debug, str, string.Empty, string.Empty, sourceLineNumber, memberName, sourceFilePath);
        }
        ...
        {
            if (logConfig.LogDebug)
                this.LogEvent("DEBUG", LogLevel.Debug, $"{str} " + (ex != null ? $"Exception - {ex.RecursivelyGetExceptionMessage()}" : string.Empty), string.Empty, string.Empty, sourceLineNumber, memberName, sourceFilePath);
        }
        ...
        public void Info(string str, [CallerLineNumber] int sourceLineNumber = 0, [CallerMemberName] string memberName = "", [CallerFilePath] string sourceFilePath = "")
        {
            if (logConfig.LogInfo)
                this.LogEvent("INFO", LogLevel.Info, str, string.Empty, string.Empty, sourceLineNumber, memberName, sourceFilePath);
        }
        ...
        {
            if (logConfig.LogInfo)
                this.LogEvent("INFO", LogLevel.Info, $"{str} " + (ex != null ? $"Exception - {ex.RecursivelyGetExceptionMessage()}" : string.Empty), string.Empty, string.Empty, sourceLineNumber, memberName, sourceFilePath);
        }
        ...
        public void Warn(string str, [CallerLineNumber] int sourceLineNumber = 0, [CallerMemberName] string memberName = "", [CallerFilePath] string sourceFilePath = "")
        {
            if (logConfig.LogWarn)
                this.LogEvent("WARNING", LogLevel.Warn, str, string.Empty, string.Empty, sourceLineNumber, memberName, sourceFilePath);
        }
        ...
        {
            if (logConfig.LogWarn)
                this.LogEvent("WARNING", LogLevel.Warn, $"{str} " + (ex != null ? $"Exception - {ex.RecursivelyGetExceptionMessage()}" : string.Empty), string.Empty, string.Empty, sourceLineNumber, memberName, sourceFilePath);
        }
        ...
        public void Error(string str, [CallerLineNumber] int sourceLineNumber = 0, [CallerMemberName] string memberName = "", [CallerFilePath] string sourceFilePath = "")
        {
            if (logConfig.LogError)
                this.LogEvent("ERROR", LogLevel.Error, str, string.Empty, string.Empty, sourceLineNumber, memberName, sourceFilePath);
        }
        ...
        {
            if (logConfig.LogError)
                this.LogEvent("ERROR", LogLevel.Error, $"{str} " + (ex != null ? $"Exception - {ex.RecursivelyGetExceptionMessage()}" : string.Empty), string.Empty, string.Empty, sourceLineNumber, memberName, sourceFilePath);
        }
        ...
        {
            if (logConfig.LogError)
                this.LogEvent("ERROR", LogLevel.Error, $"Exception - {ex.RecursivelyGetExceptionMessage()}", string.Empty, string.Empty, sourceLineNumber, memberName, sourceFilePath);
        }
        ...
        {
            this.LogEvent("FATAL", LogLevel.Fatal, str, string.Empty, string.Empty, sourceLineNumber, memberName, sourceFilePath);
        }
        ...
        {
            this.LogEvent("FATAL", LogLevel.Error, $"{str} " + (ex != null ? $"Exception - {ex.RecursivelyGetExceptionMessage()}" : string.Empty), string.Empty, string.Empty, sourceLineNumber, memberName, sourceFilePath);
        }
        ...
        {
            this.LogEvent("FATAL", LogLevel.Error, $"Exception - {ex.RecursivelyGetExceptionMessage()}", string.Empty, string.Empty, sourceLineNumber, memberName, sourceFilePath);
        }
        ...
        {
            if (logConfig.LogSql)
                this.LogEvent("SQL-COMMIT-TRANSACTION", LogLevel.Info, functionCalled ? "Called" : (" Decrement Count - " + count.ToString()), string.Empty, string.Empty, sourceLineNumber, memberName, sourceFilePath);
        }
        ...
        {
            if (logConfig.LogSql)
                LogEvent("SQL-ROLLBACK-TRANSACTION", LogLevel.Info, functionCalled ? "Called" : (" Decrement Count - " + count.ToString()), string.Empty, string.Empty, sourceLineNumber, memberName, sourceFilePath);
        }
        ...
        {
            if (logConfig.LogError)
                this.LogEvent("SQL-ERROR", LogLevel.Info, sqlStr, string.Empty, string.Empty, sourceLineNumber, memberName, sourceFilePath);
        }
